...
#include "ml/scheduler/CosineAnnealingLRScheduler.h"
...
class CosineAnnealingLRSchedulerTest : public ::testing::Test {};
...
TEST_F(CosineAnnealingLRSchedulerTest, Constructor_InitializesCorrectly) {
    ...
    EXPECT_EQ(scheduler.getTMax(), 10u);
}
...
TEST_F(CosineAnnealingLRSchedulerTest, SetTMax_UpdatesCorrectly) {
    ...
    EXPECT_EQ(scheduler.getTMax(), 20u);
}
