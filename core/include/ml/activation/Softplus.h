...
template <typename T> class Softplus : public Activation<T> {
  public:
     ...
     * @return std::shared_ptr<ComputeNode<T>> The output compute node with softplus applied.
     */
 ...
 * @return std::shared_ptr<ComputeNode<T>> The output compute node with softplus applied.
 */
template <typename T> std::shared_ptr<ComputeNode<T>> softplus(std::shared_ptr<ComputeNode<T>> input);
