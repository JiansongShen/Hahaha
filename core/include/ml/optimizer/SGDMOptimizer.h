...
#ifndef HAHAHA_SGDWOPTIMIZER_H_E57DB5EDFD0E4CC4914AB64FBF0C0859
#define HAHAHA_SGDWOPTIMIZER_H_E57DB5EDFD0E4CC4914AB64FBF0C0859
#include <vector>
#include "Optimizer.h"

namespace hahaha::ml {

template <typename T> class SGDWOptimizer : public Optimizer<T> {
  public:
    /**
     * @brief Construct a new SGDWOptimizer.
     * @param parameters List of tensors to optimize.
     * @param learningRate Learning rate.
     */
    SGDWOptimizer(std::vector<Tensor<T>> parameters, T learningRate)
...
#endif // HAHAHA_SGDWOPTIMIZER_H_E57DB5EDFD0E4CC4914AB64FBF0C0859
